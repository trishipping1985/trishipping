    ...
    <div className="flex flex-col items-center text-center">
      <div
        className={`flex h-14 w-14 items-center justify-center rounded-full border text-lg font-bold ${
            ...
            ? "border-[#F5C84B] bg-[#F5C84B] text-black"
      ...
      <div className="w-full max-w-5xl rounded-3xl border border-white/10 bg-white/5 p-10 shadow-2xl">
        ...
        <div className="mt-12">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            <Step title="Received" done={currentStep > 1} active={currentStep === 1} />
            <Step title="In Transit" done={currentStep > 2} active={currentStep === 2} />
            <Step
              title="Out for Delivery"
              done={currentStep > 3}
              active={currentStep === 3}
            />
            <Step title="Delivered" done={currentStep > 4} active={currentStep === 4} />
          </div>
        </div>
